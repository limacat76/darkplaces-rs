...
====================
*/
static bool PK3_OpenLibrary (void)
{
#ifdef LINK_TO_ZLIB
	return true;
#else
...
====================
*/
static bool PK3_GetEndOfCentralDir (const char *packfile, filedesc_t packhandle, pk3_endOfCentralDir_t *eocd)
{
...
====================
*/
static pack_t *FS_LoadPackPK3FromFD (const char *packfile, filedesc_t packhandle, bool silent)
{
...
static filedesc_t FS_SysOpenFiledesc(const char *filepath, const char *mode, bool nonblocking);
...
============
*/
static unsigned char *FS_LoadAndCloseQFile (qfile_t *file, const char *path, mempool_t *pool, bool quiet, fs_offset_t *filesizepointer)
{
...
============
*/
unsigned char *FS_SysLoadFile (const char *path, mempool_t *pool, bool quiet, fs_offset_t *filesizepointer)
{
